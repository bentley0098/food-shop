...
<template>
  <div>
    <div class="mx-auto max-w-[640px] space-y-10 p-6">
      ...
      <section class="space-y-3">
        <h2 class="u-label">AppHeader</h2>
        <div class="overflow-hidden rounded-[var(--radius-md)] border border-[var(--ui-line)]">
      ...
      <section class="space-y-3 pb-20">
        <h2 class="u-label">AppBottomNav (also rendered live, fixed, below)</h2>
      </section>
    </div>
    <AppBottomNav />
  </div>
